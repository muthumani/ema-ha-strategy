...
def test_calculate_performance_metrics():
    ...
    trades = [
        {
            ...
            'exit_time': '2023-01-01 11:00:00',
            'pnl': 1000,
            'duration': 60  # 60 minutes
        },
        {
            'entry_time': '2023-01-02 10:00:00',
            'exit_time': '2023-01-02 11:00:00',
            'pnl': -500,
            'duration': 60
        },
        {
            'entry_time': '2023-01-03 10:00:00',
            'exit_time': '2023-01-03 11:00:00',
            'pnl': 2000,
            'duration': 60
        },
        {
            'entry_time': '2023-01-04 10:00:00',
            'exit_time': '2023-01-04 11:00:00',
            'pnl': -300,
            'duration': 60
        }
    ]
    ...
    assert metrics['profit_factor'] == 3000 / 800  # winning_profit / abs(losing_profit)
    assert metrics['return_pct'] == 22.0
    assert metrics['avg_trade_duration'] == 60.0
